...
7. No encryption -- data stored as plaintext in Firestore, do not use CryptoJS
8. Data access -- DataContext (src/contexts/DataContext.jsx) does NOT exist yet. It is Phase 2 item #1. Until then, pages call src/db/index.js directly. Do not create DataContext unless explicitly building Phase 2 item #1.
9. Categories and recurring items -- always live from Firestore, never hardcoded
